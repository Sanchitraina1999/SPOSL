...
public class pass2 {
	...
	public static void main(String[] args) {
		...
		try {
			File f = new File("/home/imsotired/Desktop/TE/SPOSL/passTwoMacro/input.asm");
			File f2 = new File("/home/imsotired/Desktop/TE/SPOSL/passTwoMacro/kp.txt");
			File f3 = new File("/home/imsotired/Desktop/TE/SPOSL/passTwoMacro/mdt.txt");
				...
				if (check[0].equals("true")) {
					...
					if (total > aptab.size()) {
						...
						while (sc2.hasNextLine()) {
							...
							if (Integer.parseInt(keyline[0]) >= Integer.parseInt(check[5])
									&& Integer.parseInt(keyline[0]) <= Integer.parseInt(check[5])
											+ Integer.parseInt(check[3]) - 1) {
